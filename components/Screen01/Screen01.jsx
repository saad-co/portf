import Screen01SVGComp from "./Screen01SVGComp";

export default function Screen01() {
  return (
    <section
      id="home"
      className="flex bg-main bg-no-repeat bg-cover items-center md:mb-[-90px]">
      <div className="max-w-7xl md:pb-40 ~px-4/8 mx-auto flex flex-col-reverse items-center sm:flex-row sm:justify-between w-full">
        <div className="sm:w-1/2 pb-10 flex flex-col justify-center gap-7 sm:pt-36">
          <h1 className="text-customYellow w-full font-bold ~text-3xl/5xl">
          ...
          <ol className="list-disc pl-5 pt-3 ~text-base/xl font-bold">
