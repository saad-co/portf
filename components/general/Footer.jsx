        ...
        <section className="flex bg-[#380D0D] bg-no-repeat bg-cover items-center">
            <div className="max-w-7xl mx-auto ~px-4/8 pb-20 ~gap-8/16 flex flex-col justify-center items-center">
                <div className="grid md:grid-cols-3 grid-cols-1 gap-10 pt-32 w-full">
                    ...
                    <div className="flex flex-col items-center md:hidden">
                        <div className="flex flex-col gap-4 w-full">
                            <div className="flex w-full justify-between items-center">
                                ...
                                <RiArrowDropDownLine
                                    onClick={toggle}
                                    className={`duration-400 text-3xl ${openMenu ? "rotate-180" : "rotate-0"
                                        }`}
                                />
                            </div>
                            <div
                                className={`grid transition-all duration-500 ease-out ${!openMenu ? "grid-rows-[0fr]" : "grid-rows-[1fr]"
                                    }`}>
                    ...
                    <div className="flex flex-col items-center md:hidden pb-10">
                        <div className="flex flex-col gap-4 w-full">
                            <div className="flex w-full justify-between items-center">
                                <h1 className="text-2xl font-bold text-start">Our SERVICES</h1>
                                <RiArrowDropDownLine
                                    onClick={toggle1}
                                    className={`duration-400 text-3xl ${openMenu1 ? "rotate-180" : "rotate-0"
                                        }`}
                                />
                            </div>
                            <div
                                className={`grid transition-all duration-500 ease-out ${!openMenu1 ? "grid-rows-[0fr]" : "grid-rows-[1fr]"
                                    }`}>
                                <ul className="inner overflow-hidden text-base text-start flex flex-col gap-4">
                                    <li>Mobile GameS </li>
                                    <li>3D GameS</li>
                ...
                <div className="flex flex-col-reverse gap-4 md:flex-row w-full justify-between pt-7 md:pt-0">
